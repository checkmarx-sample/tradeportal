	...
	<tr valign="mtop">
		<td colspan="2">
			<table cellpadding="0" cellspacing="0" border="0">
				<tr valign="middle">
					<td id="utilities" align="right"><a >Find Offices</a> | <a >Contact Us</a> | <a >Site Map</a>&nbsp;</td>
            ...
            <table cellpadding="0" cellspacing="0" border="0">
                <tr valign="top">
                    ...
                    <td valign="top" id="userid" align="center">
                    	<br/>
			            <b>Sign Up with Trade Portal today!</b>

                        <!-- When the user was redirected from one of the banks that were acquired, RWi states the name of the old bank
                        Example: http://yoursite.com/tradeportal/login/Register.action?template=/pages/acquired/first_tradeportal_invest.jsp
                        -->
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" align="left" id="right" valign="top">
                        	<s:form action="PerformRegistration" method="POST" theme="simple">
                                ...
                                <tr valign="top" class="footer">
                                    <td colspan="3">
                                        <br />
                                        <p id="footerNav"><a >About Trade Portal</a> | <a >Careers</a> | <a >Privacy, Security &amp; Legal</a> | <a >Report Email Fraud</a> | <a >Diversity &amp; Accessibility</a>  <br /><a >Important Notice on Trading in Fast Markets</a> | <a >Online Access Agreement (3/06/2018) </a> | <a >Sitemap</a></p>
                                    </td>
                                </tr>
                            </s:form>
                        </table>
