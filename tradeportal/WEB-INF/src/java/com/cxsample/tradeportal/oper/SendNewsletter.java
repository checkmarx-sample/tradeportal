...
import com.cxsample.tradeportal.model.Message;
...
public class SendNewsletter extends AdminSupport {
    ...
    public String[] getMailCommand()
    {
        ...
        if (System.getProperty("os.name").toLowerCase().contains("windows"))
        {
            ...
            cp = System.getProperty("catalina.home") + "\\webapps\\tradeportal\\WEB-INF\\classes";
            cmd[2] = "\"\"" + java + "\" -cp \""+ cp +"\" com.cxsample.tradeportal.legacy.mail.SendMail \"" + subject + "\" \"" + "high" + "\" \"" + body + "\" " + "all@rwi.com" + "\"";
        }
        else
        {
            cmd[0] = "/bin/sh";
            cmd[1] = "-c";
            java = System.getProperty("java.home") + "/bin/java";
            cp = System.getProperty("catalina.home") + "/webapps/tradeportal/WEB-INF/classes";
            cmd[2] = "\"" + java + "\" -cp \""+ cp +"\" com.cxsample.tradeportal.legacy.mail.SendMail \"" + subject + "\" \"" + "high" + "\" \"" + body + "\" " + "all@rwi.com";
        }
    ...
    private void updateMail() {
        String sender = "tradeportal Bank";
