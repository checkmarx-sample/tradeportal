package com.cxsample.tradeportal.database;
...
System.out.println("datasource before");
            datasource = (DataSource)ctx.lookup("java:comp/env/jdbc/tradeportal");
System.out.println("datasource after");            
            if (datasource == null)
            {
                throw new Exception("Boom - No java:comp/env/jdbc/tradeportal");
            }
        }
        catch (Exception e)
        {
