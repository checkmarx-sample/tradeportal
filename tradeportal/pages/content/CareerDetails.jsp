...
<td valign="top" align="center">
    ...
    <c:choose>
        <c:when test="${param.j_clerk1 != null}" >
            Runner Position 1: You will work regular business hours. Good benefit program
        </c:when>
    </c:choose>

    <c:choose>
        <c:when test="${param.j_clerk2 != null}" >
            Runner Position 2: You will work regular business hours. Good benefit program
        </c:when>
    </c:choose>
    ...
    <c:choose>
        <c:when test="${param.s_account != null}" >
            Senior Broker: Great pay, good benefit program
        </c:when>
    </c:choose>
